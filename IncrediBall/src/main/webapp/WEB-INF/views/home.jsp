			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="d-block w-100"
						src="https://i.imgur.com/ByJepjt.jpg/1000x350?auto=yes&bg=777&fg=555&text=First slide"
						alt="First slide">
				...
				<div class="carousel-item">
					<img class="d-block w-100"
						src="https://i.imgur.com/ByJepjt.jpg/1000x350?auto=yes&bg=666&fg=444&text=Second slide"
						alt="Second slide">
					<div class="carousel-caption d-none d-md-block">
						<h3>2nd</h3>
						<p>2nd slide</p>
				...
				<div class="carousel-item">
					<img class="d-block w-100"
						src="https://i.imgur.com/ByJepjt.jpg/1000x350?auto=yes&bg=555&fg=333&text=Third slide"
						alt="Third slide">
					<div class="carousel-caption d-none d-md-block">
						<h3>3rd</h3>
						<p>3rd slide</p>
